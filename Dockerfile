...
LABEL org.opencontainers.image.title="y0n1x's AI Lab - Open-WebUI" \
    ...
    com.docker.extension.screenshots="https://raw.githubusercontent.com/mairie-de-saint-jean-cap-ferrat/docker-desktop-open-webui/refs/heads/main/screenshot.png" \
